          ...
          {isMobileOpen && (
            <>
              ...
              <motion.div
                ...
                className="fixed inset-0 bg-[#020817]/55 backdrop-blur-md lg:hidden"
              />
              ...
              <motion.div
                ...
                className="fixed right-0 top-0 z-50 flex h-full w-[300px] flex-col overflow-hidden border-l border-white/10 bg-[#071827]/96 shadow-[0_0_90px_rgba(0,0,0,0.45)] backdrop-blur-2xl lg:hidden"
              >
                {/* TOP */}
